import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,a as t}from"./app-f916d83f.js";const p={},e=t(`<p>在上一个总结中我们在实现线程安全的map的时候用到了锁的概念，面试官听到这个锁的实现方法之后双眼冒光，开始了新一轮的攻势。问：互斥锁和读写锁有啥区别？</p><h3 id="sync-mutex互斥锁" tabindex="-1"><a class="header-anchor" href="#sync-mutex互斥锁" aria-hidden="true">#</a> sync.Mutex互斥锁</h3><p>Go中标准包提供sync.Mutex类型实现mutex(排他锁、互斥锁)。定义：</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token comment">// A Mutex is a mutual exclusion lock.</span>
