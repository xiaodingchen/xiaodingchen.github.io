import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,a as t}from"./app-3791dda3.js";const e={},p=t(`<h2 id="_1-写出以下逻辑-要求每秒钟调用一次proc并保证程序不退出" tabindex="-1"><a class="header-anchor" href="#_1-写出以下逻辑-要求每秒钟调用一次proc并保证程序不退出" aria-hidden="true">#</a> 1. 写出以下逻辑，要求每秒钟调用一次proc并保证程序不退出?</h2><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> main
