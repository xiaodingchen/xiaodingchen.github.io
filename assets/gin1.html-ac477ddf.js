import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,a as t}from"./app-5c6114be.js";const p={},e=t(`<h2 id="构建servemux" tabindex="-1"><a class="header-anchor" href="#构建servemux" aria-hidden="true">#</a> 构建ServeMux</h2><p>net/http包中有默认的DefaultServeMux，gin框架也实现了这个，主要是实现 http.Handler接口，接口只包含一个方法 <code>ServeHTTP(ResponseWriter, *Request)</code></p><p>我们看下gin中怎么实现的</p><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code>
