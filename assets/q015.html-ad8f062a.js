import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o as e,c,b as n,d as s,e as o,a as i}from"./app-5c6114be.js";const l={},u=n("h1",{id:"golang-并发题目测试",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#golang-并发题目测试","aria-hidden":"true"},"#"),s(" golang 并发题目测试")],-1),d={href:"https://colobu.com/2019/04/28/go-concurrency-quizzes/",target:"_blank",rel:"noopener noreferrer"},k=i(`<h3 id="_1-mutex" tabindex="-1"><a class="header-anchor" href="#_1-mutex" aria-hidden="true">#</a> 1 Mutex</h3><div class="language-go line-numbers-mode" data-ext="go"><pre class="language-go"><code><span class="token keyword">package</span> main
