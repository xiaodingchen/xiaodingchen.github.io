import{_ as o}from"./plugin-vue_export-helper-c27b6911.js";import{r as c,o as a,c as d,b as e,d as n,e as i,a as t}from"./app-f916d83f.js";const l={},s=t(`<h2 id="发现问题" tabindex="-1"><a class="header-anchor" href="#发现问题" aria-hidden="true">#</a> 发现问题</h2><p>在<code>docker build</code>时发现docker context 随着时间的增长，build越慢，context越大。<br> 这个时候就需要使用.dockerignore文件忽略非必要的上下文。<br> 比如： logs、upload等文件目录<br> .dockerignore 文件类似于.gitignore文件，格式如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>logs/
upload/
*.jar
*.zip
bin/
